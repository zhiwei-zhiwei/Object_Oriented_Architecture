...
public class ORCLAvgStdDevAggregator {
        ...
        context.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                ...
                from("direct:average")
                        ...
                        .to("jms:queue:ORCLAvgAggregatedStockQuotes")
                ...
                from("direct:standardDeviation")
                        ...
                        .to("jms:queue:ORCLStdDevAggregatedStockQuotes")
                        .log("Aggregated Message Sent: ${body}");
            }
        });
